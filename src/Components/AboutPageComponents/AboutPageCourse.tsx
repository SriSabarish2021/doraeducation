      ...
      <div className='about-page-course-box'>
         ...
         <div className='about-page-program-list'>
          <div className='abt-prog-list-tit-div'>
               ...
               <p className='span-prog-list-abt-tit'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis, quibusdam. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Sapiente, porro!</p>
               <button className='abt-page-btn-prog-list'>More Course <FaArrowRight className='right-arrow-icon'/>
               <div className='abt-page-prog-list-btn-one-des'></div>
               <div className='abt-page-prog-list-btn-two-des'></div>
               </button>
          </div>
        
          <div className='about-page-prog-one prog-one-ani-abt-page'>
            <div className='about-page-prog-img'></div>
            <div className='about-page-prog-cont'>
              <div className='level-in-prog-ab-list'>Beginner</div>
              <div className='prog-list-abt-page-cont-div'>
                <p className='prog-abt-page-title'>BSC.in MatheMatics</p>
                <p className='prog-abt-page-cont'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut nisi id doloremque quo culpa, at accusantium vel iste o</p>
              </div>
              
              <div className='addi-info-prog-list-abt-page'>
                <p className='addi-info-cont-one'><PiClock className='icon-prog-list-abt-page'/>2 Years</p>
                <p className='addi-info-cont-two'><PiReadCvLogo className='icon-prog-list-abt-page'/>5+ Credits</p>
                <button className='addi-info-cont-btn'>Apply
                  <div className='abt-page-prog-list-btn-design'></div>
                </button>
              </div>
            </div>
          </div>
          <div className='about-page-prog-one'>
            <div className='about-page-prog-img'></div>
            <div className='about-page-prog-cont'>
              <div className='level-in-prog-ab-list'>Beginner</div>
              <div className='prog-list-abt-page-cont-div'>
          ...
          <div className='about-page-prog-one prog-two-ani-abt-page'>
            <div className='about-page-prog-img'></div>
            <div className='about-page-prog-cont'>
              <div className='level-in-prog-ab-list'>Beginner</div>
              <div className='prog-list-abt-page-cont-div'>

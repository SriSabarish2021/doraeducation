...
const StepPageAbout = () => {
  ...
  return (
    <div className='step-page-container-for-about-page'>
        ...
        <div className='step-container-in-about-page'>
            ...
            <div className='step-about-page step-one-about'>
                ...
                <p className='step-title-about-page'>Join The Team</p>
                <p className='step-para-about-page'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates, harum.</p>
